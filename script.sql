...
--
-- Name: order_item fk967bbc2de8e8quljxc380tmwf; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_item
    ADD CONSTRAINT fk967bbc2de8e8quljxc380tmwf FOREIGN KEY (order_id) REFERENCES public.tb_order(id);
...
--
-- Name: order_item fkr7ng2q2yevtebr06ynqk23ph7; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_item
    ADD CONSTRAINT fkr7ng2q2yevtebr06ynqk23ph7 FOREIGN KEY (product_id) REFERENCES public.tb_product(id);
